              ...
              {loading ? (
                ...
                demos.map((d) => (
                  <tr key={d._id} className="hover:bg-white/5 transition-colors">
                    <td className="px-5 py-4 font-heading font-bold text-[#FFFFFF]">
                    ...
                    <td className="px-5 py-4">
                      <div className="font-semibold text-[#FFFFFF]">{d.fullName || d.name || 'Client Lead'}</div>
                      <div className="text-[11px] text-[#c4d7f5]/60">
                        {(d.companyName || d.company || 'Corporate')} &bull; {d.email || 'N/A'}
                      </div>
                      {d.requirements && (
                        <div className="text-[11px] text-[#2B6EFA] italic mt-0.5 line-clamp-1">"{d.requirements}"</div>
                      )}
                    </td>

                    <td className="px-5 py-4 font-mono text-[#c4d7f5]">
