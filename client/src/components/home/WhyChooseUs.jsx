...
export default function WhyChooseUs() {
  ...
  return (
    <section className="relative py-24 sm:py-32 bg-[#070E24] border-y border-[rgba(43,110,250,0.2)] overflow-hidden">
      <FloatingCubes />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[rgba(43,110,250,0.12)] border border-[rgba(0,212,255,0.3)] text-[#2B6EFA] text-xs font-semibold uppercase tracking-wider">
              The Techofay Advantage
            </div>

            <h2 className="font-heading font-extrabold text-2xl sm:text-4xl text-[#FFFFFF] tracking-tight leading-tight">
              Why Global Industry Leaders <span className="text-[#2B6EFA]">Choose Techofay</span>
            </h2>
            ...
            <div className="space-y-3 pt-2">
              <div className="flex items-center gap-3 text-xs sm:text-sm text-[#FFFFFF] font-medium bg-[rgba(43,110,250,0.12)] border border-[rgba(0,212,255,0.3)] p-3 rounded-lg">
                <CheckCircle2 className="w-5 h-5 text-[#2B6EFA] shrink-0" />
                <span>100% Money-Back Guarantee: If you don’t get clients, we refund you!</span>
              </div>
              <div className="flex items-center gap-3 text-xs sm:text-sm text-[#c4d7f5] font-medium">
                <CheckCircle2 className="w-5 h-5 text-[#2B6EFA] shrink-0" />
            ...
            <div className="pt-4">
              <Link
                to="/about"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-lg font-semibold text-xs text-white font-semibold bg-[#2B6EFA] hover:bg-[#1E50C8] transition-colors shadow-sm cursor-pointer"
              >
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
            {points.map((pt, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-[rgba(255,255,255,0.05)] rounded-xl p-6 sm:p-7 flex flex-col justify-between border border-[rgba(43,110,250,0.2)] border-l-4 border-l-[#2B6EFA] hover:border-[rgba(0,212,255,0.4)] hover:shadow-[0_8px_32px_rgba(43,110,250,0.1)] transition-all duration-300 group backdrop-blur-md"
                >
                  <div>
                    {/* Icon container: rgba(43,110,250,0.2) bg, #2B6EFA icon */}
                    <div className="w-12 h-12 rounded-full bg-[rgba(43,110,250,0.2)] flex items-center justify-center text-[#2B6EFA] group-hover:scale-105 transition-transform mb-5">
                      <Icon className="w-6 h-6" />
                    </div>
                    <h3 className="font-heading font-bold text-base text-[#FFFFFF] mb-2 group-hover:text-[#2B6EFA] transition-colors">
                      {pt.title}
                    </h3>
                  ...
                  <div className="mt-5 pt-3 border-t border-[rgba(43,110,250,0.2)] flex items-center justify-between">
