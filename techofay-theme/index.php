    ...
    <?php if ( have_posts() ) : ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            while ( have_posts() ) :
                the_post();
                ?>
                <article id="post-<?php the_ID(); ?>" <?php post_class( 'bg-[#0A1628] rounded-2xl p-7 flex flex-col justify-between border border-[rgba(43,110,250,0.2)] hover:border-[#2B6EFA] shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1' ); ?>>
                    <?php if ( has_post_thumbnail() ) : ?>
                        <div class="aspect-video w-full rounded-xl overflow-hidden mb-5 bg-[#070E24]">
