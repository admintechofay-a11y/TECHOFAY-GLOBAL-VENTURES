...
?>
    ...
    <footer id="colophon" class="relative bg-[#050B1F] border-t border-[rgba(43,110,250,0.2)] text-[#F9FAFB] overflow-hidden pt-16 pb-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            
            <!-- Top Section: Brand + Newsletter -->
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 pb-14 border-b border-[rgba(43,110,250,0.2)]">
                <div class="lg:col-span-6 space-y-4">
                    ...
                    <div class="flex flex-wrap items-center gap-2 pt-2">
                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded bg-[#0A1628] border border-[rgba(43,110,250,0.2)] text-[11px] font-medium text-[#E5E7EB]">
                            <svg class="w-3.5 h-3.5 text-[#00D4FF]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                            ISO 27001:2022
                        </span>
                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded bg-[#0A1628] border border-[rgba(43,110,250,0.2)] text-[11px] font-medium text-[#E5E7EB]">
                            <svg class="w-3.5 h-3.5 text-[#00D4FF]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                            SOC 2 Type II
                        </span>
                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded bg-[#0A1628] border border-[rgba(43,110,250,0.2)] text-[11px] font-medium text-[#E5E7EB]">
                            <svg class="w-3.5 h-3.5 text-[#00D4FF]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 00-9.78 2.096A4.001 4.001 0 003 15z"/></svg>
                            AWS Partner
                        </span>
                    </div>
                </div>
                ...
                <div class="lg:col-span-6 flex flex-col justify-center">
                    ...
                    <form id="footer-newsletter-form" class="flex gap-2 max-w-md">
                        <input
                            ...
                            class="flex-1 px-4 py-2.5 rounded-lg bg-[#0A1628] border border-[rgba(43,110,250,0.2)] text-white text-sm focus:outline-none focus:border-[#00D4FF] focus:ring-1 focus:ring-[#00D4FF] placeholder:text-[#8B9AB5]"
                        />
                        <button
                            type="submit"
                            class="px-5 py-2.5 rounded-lg font-medium text-sm text-[#1c1400] font-semibold bg-[#2B6EFA] hover:bg-[#1E50C8] transition-all flex items-center gap-2"
                        >
                            <span>Subscribe</span>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8 py-12">
                <!-- Col 1: Company -->
                <div>
                    <h4 class="font-heading text-xs font-bold uppercase tracking-wider text-[#00D4FF] mb-4">
                        Company
                    </h4>
                    <ul class="space-y-2.5 text-xs text-[#9CA3AF]">
                        ...
                        <li><a href="<?php echo esc_url( home_url( '/about#leadership' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Executive Leadership</a></li>
                        <li><a href="<?php echo esc_url( home_url( '/careers' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Careers & Culture <span class="ml-1 text-[10px] text-[#00D4FF] bg-[#2B6EFA]/20 px-1.5 py-0.5 rounded">Hiring</span></a></li>
                        <li><a href="<?php echo esc_url( home_url( '/about#offices' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Global Offices</a></li>
                        <li><a href="<?php echo esc_url( home_url( '/contact' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Press & Media</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-xs text-[#9CA3AF]">
                        <li><a href="<?php echo esc_url( home_url( '/service/development' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Website & App Development</a></li>
                        <li><a href="<?php echo esc_url( home_url( '/service/ai-data-analytics' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Custom AI Development</a></li>
                        <li><a href="<?php echo esc_url( home_url( '/service/growth-marketing' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">SEO & Social Media Marketing</a></li>
                        <li><a href="<?php echo esc_url( home_url( '/service/growth-marketing' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Digital Marketing & Branding</a></li>
                        <li><a href="<?php echo esc_url( home_url( '/products' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Smart NFC Business Cards</a></li>
                        <li><a href="<?php echo esc_url( home_url( '/service/cybersecurity' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Cybersecurity & Cloud DevOps</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-xs text-[#9CA3AF]">
                        <li><a href="<?php echo esc_url( home_url( '/products' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">ERP Management Software</a></li>
                        <li><a href="<?php echo esc_url( home_url( '/products' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Hospital Management (HMS)</a></li>
                        <li><a href="<?php echo esc_url( home_url( '/products' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">School Management Software</a></li>
                        <li><a href="<?php echo esc_url( home_url( '/products' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Hotel Management (HMS)</a></li>
                        <li><a href="<?php echo esc_url( home_url( '/products' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Transport & Fleet Software</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-xs text-[#9CA3AF]">
                        <li><a href="<?php echo esc_url( home_url( '/blog' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Engineering Insights</a></li>
                        <li><a href="<?php echo esc_url( home_url( '/blog' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Case Studies</a></li>
                        <li><a href="<?php echo esc_url( home_url( '/service/cybersecurity' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Zero Trust Whitepapers</a></li>
                        <li><a href="<?php echo esc_url( home_url( '/contact' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Developer API Docs</a></li>
                        <li><a href="<?php echo esc_url( home_url( '/wp-admin' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Client Portal Login</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="text-xs leading-relaxed text-[#9CA3AF] mb-3 space-y-1.5">
                        <div>
                            <span class="text-[#00D4FF] font-semibold">Headquarters:</span> Vadodara, Gujarat, India
                        </div>
                        <div>
                    ...
                    <div class="text-xs text-[#9CA3AF] mb-3 space-y-1">
                        <div>
                            Direct: <a href="tel:+919359339000" class="text-white hover:text-[#00D4FF] font-mono transition-colors">+91-9359339000</a>
                        </div>
                        <div>
                            Email: <a href="mailto:info@techofay.com" class="text-white hover:text-[#00D4FF] transition-colors">info@techofay.com</a> &bull; <a href="mailto:director@techofay.com" class="text-white hover:text-[#00D4FF] transition-colors">director@techofay.com</a>
                        </div>
                        <div class="text-[11px] pt-0.5">
                            Web: <a href="https://www.techofay.com" target="_blank" rel="noreferrer" class="text-[#00D4FF] hover:underline">www.techofay.com</a> &bull; <a href="https://www.techofay.in" target="_blank" rel="noreferrer" class="text-[#00D4FF] hover:underline">www.techofay.in</a>
                        </div>
                    </div>
                    <div class="text-[11px] font-mono text-[#00D4FF] flex items-center gap-1.5">
            ...
            <div class="pt-8 border-t border-[rgba(43,110,250,0.2)] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
                <div class="flex items-center gap-4">
                    <a href="https://linkedin.com/company/techofay" target="_blank" rel="noreferrer" class="w-8 h-8 rounded-full bg-[#0A1628] flex items-center justify-center text-[#9CA3AF] hover:bg-[#2B6EFA]/20 hover:text-[#00D4FF] transition-all" aria-label="LinkedIn">
                    ...
                    <a href="https://twitter.com/techofay" target="_blank" rel="noreferrer" class="w-8 h-8 rounded-full bg-[#0A1628] flex items-center justify-center text-[#9CA3AF] hover:bg-[#2B6EFA]/20 hover:text-[#00D4FF] transition-all" aria-label="Twitter">
                        <svg class="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                    </a>
                    <a href="https://github.com/admintechofay-a11y" target="_blank" rel="noreferrer" class="w-8 h-8 rounded-full bg-[#0A1628] flex items-center justify-center text-[#9CA3AF] hover:bg-[#2B6EFA]/20 hover:text-[#00D4FF] transition-all" aria-label="GitHub">
                ...
                <div class="flex items-center gap-4 text-[#9CA3AF]">
                    <a href="<?php echo esc_url( home_url( '/contact' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Privacy Policy</a>
                    <span>&bull;</span>
                    <a href="<?php echo esc_url( home_url( '/contact' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Terms of Service</a>
                    <span>&bull;</span>
                    <a href="<?php echo esc_url( home_url( '/contact' ) ); ?>" class="hover:text-[#00D4FF] transition-colors">Cookie Policy</a>
                </div>
            </div>
        </div>
    </footer>
    ...
    <div id="quick-connect-widget" class="fixed bottom-6 right-6 z-50">
        ...
        <div id="quick-chat-drawer" class="hidden mb-3 w-80 sm:w-96 bg-[#070E24] border border-[rgba(37,211,102,0.4)] rounded-3xl shadow-[0_10px_50px_rgba(0,0,0,0.8)] overflow-hidden backdrop-blur-2xl text-left animate-scale-up">
            ...
            <div class="p-4 bg-gradient-to-r from-[#128C7E] to-[#25D366] text-white flex items-center justify-between">
                <div class="flex items-center gap-2.5">
                    <div class="w-9 h-9 rounded-full bg-[#0A1628]/20 flex items-center justify-center font-bold text-sm">
                        💬
                    </div>
                    <div>
                        <div class="font-heading font-bold text-xs tracking-wider flex items-center gap-1.5">
                            <span>TECHOFAY DIRECT DESK</span>
                            <span class="w-2 h-2 rounded-full bg-[#0A1628] animate-pulse"></span>
                        </div>
        ...
        >
            <div class="relative">
                ...
                <span id="launcher-ping" class="absolute -top-1 -right-1 w-2.5 h-2.5 bg-[#0A1628] rounded-full animate-ping"></span>
            </div>
