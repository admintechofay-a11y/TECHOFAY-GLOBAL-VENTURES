                    ...
                    <?php if ( ! empty( $recent_inquiries ) ) : ?>
                        <?php foreach ( $recent_inquiries as $inq ) : ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span style="display: inline-block; padding: 2px 8px; border-radius: 4px; font-size: 11px; font-weight: 600; <?php echo $status === 'Resolved' ? 'background: #dcfce7; color: #166534;' : ($status === 'In Progress' ? 'background: #fef9c3; color: #854d0e;' : 'background: #e0f2fe; color: #075985;'); ?>">
