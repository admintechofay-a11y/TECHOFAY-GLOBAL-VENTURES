        ...
        <div class="lg:col-span-5 space-y-8">
            <div class="glass-panel rounded-3xl p-8 border border-[rgba(43,110,250,0.3)] space-y-6">
                ...
                <div class="space-y-4 text-xs sm:text-sm">
                    <div class="p-4 rounded-2xl bg-white/5 border border-white/10 flex items-start gap-4">
                ...
                <form id="techofay-contact-form" class="space-y-5">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="fullName" required class="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white text-xs focus:outline-none focus:border-[#00D4FF]" placeholder="Marcus Vance" />
                        </div>
                        <div>
                            <label class="block text-xs font-semibold text-[#8B9AB5] mb-1.5 uppercase">Corporate Email *</label>
                            <input type="email" name="email" required class="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white text-xs focus:outline-none focus:border-[#00D4FF]" placeholder="marcus@enterprise.com" />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="tel" name="phone" required class="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white text-xs focus:outline-none focus:border-[#00D4FF]" placeholder="+91 93593 39000" />
                        </div>
                        <div>
                            <label class="block text-xs font-semibold text-[#8B9AB5] mb-1.5 uppercase">Company Name</label>
                            <input type="text" name="companyName" class="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white text-xs focus:outline-none focus:border-[#00D4FF]" placeholder="Vance Global Inc." />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="message" required rows="4" class="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white text-xs focus:outline-none focus:border-[#00D4FF]" placeholder="Brief description of current infrastructure, user concurrency expectations, key compliance certifications required, or desired deployment timeline..."></textarea>
                    </div>
