...
<main id="primary" class="site-main min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-[#161616]">
    <!-- Header -->
    <div class="text-center max-w-3xl mx-auto mb-16 space-y-4">
        ...
        <div class="text-sm text-[#D97706] leading-relaxed">
    ...
    <?php if ( have_posts() ) : ?>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <?php while ( have_posts() ) : the_post(); ?>
                <article class="bg-[#1A1A1A] rounded-2xl p-7 flex flex-col justify-between border border-[rgba(245,158,11,0.15)] hover:border-[#F59E0B] shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    <div>
                        <?php if ( has_post_thumbnail() ) : ?>
                            <div class="rounded-xl overflow-hidden aspect-video w-full mb-5 bg-[#161616]">
                    ...
                    <div class="pt-4 border-t border-[rgba(245,158,11,0.15)]">
    ...
    <?php else : ?>
        <div class="text-center py-20 bg-[#1A1A1A] rounded-2xl border border-[rgba(245,158,11,0.15)] p-12">
            <h2 class="text-xl font-bold text-[#FFFBEB] mb-3">No content published yet</h2>
            <p class="text-sm text-[#D97706]">Stay tuned as our team publishes updates and insights.</p>
        </div>
    <?php endif; ?>
</main>
