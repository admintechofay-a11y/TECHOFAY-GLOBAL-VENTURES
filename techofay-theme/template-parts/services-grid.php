...
$services = array(
    ...
    array(
        ...
        'stat'      => '99.98% Clean QA',
        'icon'      => '<svg class="w-6 h-6 text-[#F59E0B]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"/></svg>',
    ...
    array(
        ...
        'badge'     => 'Autonomous AI',
        'stat'      => '120k+ Tasks/Day',
        'icon'      => '<svg class="w-6 h-6 text-[#F59E0B]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>',
    ...
    array(
        ...
        'icon'      => '<svg class="w-6 h-6 text-[#F59E0B]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>',
...
<section class="relative py-24 sm:py-32 bg-[#1A1A1A] overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="text-center max-w-3xl mx-auto mb-16 sm:mb-20">
            ...
            <h2 class="font-heading font-extrabold text-3xl sm:text-4xl lg:text-[40px] text-[#FFFBEB] tracking-tight mb-4">
                End-to-End Technology <span class="text-[#F59E0B]">Capabilities</span>
            </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <?php foreach ( $services as $vertical ) : ?>
                <div class="group relative bg-[#1A1A1A] border border-[rgba(245,158,11,0.15)] rounded-[12px] p-7 sm:p-8 flex flex-col justify-between overflow-hidden cursor-pointer transition-all duration-300 hover:border-[#F59E0B] hover:shadow-[0_8px_24px_rgba(22,163,74,0.08)]">
                    <!-- 3px Solid Forest Green Top Accent Bar -->
                    <div class="absolute top-0 left-0 right-0 h-[3px] bg-[#F59E0B]"></div>

                    <div>
                        <!-- Top Badge & Icon -->
                        <div class="flex items-center justify-between mb-6">
                            <!-- Icon container: rgba(245,158,11,0.15) bg circle, #F59E0B icon -->
                            <div class="w-12 h-12 rounded-full bg-[rgba(245,158,11,0.15)] flex items-center justify-center text-[#F59E0B] group-hover:scale-105 transition-transform duration-300">
                                <?php echo $vertical['icon']; ?>
                            </div>
                            <span class="text-[10px] uppercase font-mono tracking-wider px-2.5 py-1 rounded-md bg-[#161616] border border-[rgba(245,158,11,0.15)] text-[#FDE68A]">
                                <?php echo esc_html( $vertical['badge'] ); ?>
                            </span>
                        </div>

                        <!-- Title -->
                        <h3 class="font-heading font-bold text-lg sm:text-xl text-[#FFFBEB] mb-3 group-hover:text-[#F59E0B] transition-colors">
                            <a href="<?php echo esc_url( home_url( '/services' ) ); ?>"><?php echo esc_html( $vertical['title'] ); ?></a>
                        </h3>

                        <!-- 2-line Description -->
                        <p class="text-xs sm:text-sm text-[#FDE68A] leading-relaxed line-clamp-2 mb-6">
                        ...
                        <div class="space-y-2 mb-6">
                            <?php foreach ( $vertical['subItems'] as $item ) : ?>
                                <div class="flex items-center gap-2.5 text-xs text-[#FDE68A]">
                        ...
                        <div class="flex flex-wrap gap-1.5 mb-6 pt-3 border-t border-[rgba(245,158,11,0.15)]">
                            <?php foreach ( array_slice( $vertical['tools'], 0, 3 ) as $tool ) : ?>
                                <span class="text-[10px] font-mono px-2 py-0.5 rounded bg-[#161616] text-[#D97706] border border-[rgba(245,158,11,0.15)]">
                    ...
                    <!-- Bottom CTA Link -->
                    <div class="pt-4 border-t border-[rgba(245,158,11,0.15)] flex items-center justify-between">
                        <a
                            href="<?php echo esc_url( home_url( '/services' ) ); ?>"
                            class="inline-flex items-center gap-2 text-xs font-semibold text-[#F59E0B] hover:text-[#B45309] transition-colors group/link"
                        >
        ...
        <div class="mt-14 text-center">
            <a
                href="<?php echo esc_url( home_url( '/services' ) ); ?>"
                class="inline-flex items-center gap-2 px-8 py-3.5 rounded-lg font-semibold text-sm text-[#F59E0B] bg-[#1A1A1A] border border-[#F59E0B] hover:bg-[rgba(245,158,11,0.06)] transition-colors shadow-xs"
            >
